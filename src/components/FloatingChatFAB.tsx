...
export const FloatingChatFAB = () => {
  ...
  return (
    <>
      <div className={`fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom)+4px)] md:bottom-6 ltr:right-[env(safe-area-inset-right,8px)] rtl:left-[env(safe-area-inset-left,8px)] z-40 transition-opacity duration-700 ${visible ? "opacity-50" : "opacity-0 pointer-events-none"}`} ref={menuRef}>
        {/* Option buttons */}
        <div
