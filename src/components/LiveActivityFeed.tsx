  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4">
      ...
      <div className="relative rounded-2xl p-[2px] overflow-hidden live-feed-border">
        ...
        <div
          className="relative flex items-center gap-2.5 py-3 px-4 rounded-[14px] bg-transparent backdrop-blur-sm cursor-pointer hover:bg-background/10 transition-all duration-200 min-h-[48px]"
