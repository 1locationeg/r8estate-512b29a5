...
const ROLE_META: Record<Role, {
  ...
  buyer: {
    ...
    subtitle: "Verified reviews & AI trust.",
    perks: ["Compare devs", "Earn credits", "Scan contracts"],
  ...
  business: {
    ...
    subtitle: "Reviews, leads & widgets.",
    perks: ["Reply to buyers", "Track trust", "Embed widgets"],
  ...
  admin: {
    ...
    subtitle: "Moderate & protect.",
    perks: ["KYC queue", "Fraud detection", "Trust engine"],
    card: "border-indigo-600/20 bg-gradient-to-br from-indigo-50 to-background hover:border-indigo-600/40",
    cardActive: "border-indigo-600 bg-gradient-to-br from-indigo-600/15 to-indigo-50 ring-2 ring-indigo-600/30",
    iconWrap: "bg-indigo-600 text-white",
    badge: "bg-indigo-600/10 text-indigo-700",
    glow: "shadow-[0_8px_30px_-6px_rgba(79,70,229,0.4)]",
    pageTint: "from-indigo-600/5 via-background to-background",
  },
};
      ...
      <div className="sticky top-0 z-40 bg-gradient-to-r from-primary via-primary/90 to-primary/80 text-primary-foreground border-b border-primary/30 shadow-md">
        <div className="max-w-[1200px] mx-auto px-4 py-3 flex items-center justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-2 min-w-0">
            <Link
              to="/"
              className="shrink-0 flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-white/20 hover:bg-white/30 text-primary-foreground border border-white/30 transition-colors"
