      ...
      <div className="min-h-screen bg-muted flex items-center justify-center p-4 relative">
        ...
        <Card className="w-full max-w-md mx-auto shadow-xl border-0">
          <CardContent className="p-8 text-center space-y-6">
            ...
            {/* Inline Signup */}
            <div className="border rounded-xl p-5 bg-accent/5 space-y-4">
              <Award className="w-8 h-8 text-accent mx-auto" />
              <h3 className="font-semibold text-foreground">Claim your Verified Buyer Badge 🏅</h3>
              <p className="text-sm text-muted-foreground">Sign up to earn a badge and track your impact.</p>

              {signupStep === "options" && (
                <div className="space-y-3">
                  <Button onClick={handleGoogleSignup} variant="outline" className="w-full h-11 gap-2">
                  ...
                  <Button onClick={handleAppleSignup} variant="outline" className="w-full h-11 gap-2">
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/></svg>
                    Continue with Apple
                  </Button>
                  <div className="relative">
                    <div className="absolute inset-0 flex items-center"><span className="w-full border-t" /></div>
                    <div className="relative flex justify-center text-xs uppercase"><span className="bg-accent/5 px-2 text-muted-foreground">or</span></div>
                  </div>
                  <div className="flex gap-2">
                    ...
                    />
                    <Button onClick={handleEmailContinue} size="icon" className="shrink-0">
              ...
              {signupStep === "password" && (
                <div className="space-y-3">
                  <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    <button onClick={() => setSignupStep("options")} className="hover:text-foreground transition-colors">
                      <ArrowLeft className="w-4 h-4" />
                    </button>
                    <span className="truncate">{signupEmail}</span>
                  </div>
                  <div className="relative">
                    <Input
                  ...
                  <Button onClick={handleEmailSignup} disabled={signupLoading} className="w-full">
            ...
            <button onClick={() => navigate("/")} className="text-sm text-muted-foreground hover:text-foreground underline underline-offset-4 transition-colors">
              Skip for now →
            </button>
          </CardContent>
        </Card>
