...
const BuyerDashboard = () => {
  ...
  const stats = [
    { icon: Building2, label: 'Developers Viewed', value: '24' },
    { icon: Star, label: 'Reviews Written', value: '3' },
    { icon: Heart, label: 'Saved Projects', value: '12' },
    { icon: TrendingUp, label: 'Reports Unlocked', value: '8' },
  ];
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Continue your search for the perfect developer
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className="font-semibold">Search Developers</span>
              <span className="text-sm text-muted-foreground text-start">
                Find and compare trusted developers
              </span>
            </Button>
            <Button
              variant="outline"
            ...
            >
              ...
              <span className="font-semibold">Developer Directory</span>
              <span className="text-sm text-muted-foreground text-start">
        ...
        <div>
          ...
          <div className="bg-card border border-border rounded-xl p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Start exploring developers to see your activity here
            </p>
