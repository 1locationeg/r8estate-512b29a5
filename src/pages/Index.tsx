...
const Index = () => {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-background flex flex-col safe-x overflow-x-hidden w-full max-w-full safe-top">
      {/* Header */}
      <header className="sticky top-[env(safe-area-inset-top)] z-[100] bg-background/95 backdrop-blur-sm border-b border-border/40">
