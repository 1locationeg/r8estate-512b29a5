                               ...
                               <Tooltip>
                                 <TooltipTrigger asChild>
                                   <button
                                     ...
                                     className="animate-fade-in-up w-11 h-11 rounded-full bg-gradient-to-br from-primary via-brand-red to-accent p-[1.5px] shadow-[0_4px_12px_-2px_hsl(var(--primary)/0.25),0_2px_4px_-1px_hsl(var(--primary)/0.1)] hover:-translate-y-0.5 hover:shadow-lg transition-all duration-300 animate-pulse-glow active:scale-95"
                                     style={{ animationDelay: '200ms' }}
                                   >
                                     <div className="w-full h-full rounded-full bg-white/90 dark:bg-background/90 backdrop-blur-sm flex items-center justify-center">
