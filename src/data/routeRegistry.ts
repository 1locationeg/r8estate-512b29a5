...
export const PUBLIC_ROUTES: PublicRoute[] = [
  ...
  { name: "Compare Developers", path: "/compare" },
  { name: "Truth Check", path: "/truth-check" },
  { name: "Products", path: "/products" },
  { name: "R8 Map Demo", path: "/products/r8-map" },
  { name: "Live Demo", path: "/demo" },
  { name: "Copilot", path: "/copilot" },
  { name: "Professional Dashboard", path: "/pro-dashboard" },
  { name: "Professional Settings", path: "/pro-settings" },
  ...
  { name: "R8 Match", path: "/match" },
  { name: "Trust Meter Methodology", path: "/about-trust-meter" },
];
