...
export const reviews: Review[] = [
  ...
  },
  {
    ...
    rating: 5,
    date: "2024-02-10",
    project: "1 LOCATION Brokerage",
    comment: "Absolutely outstanding brokerage experience! 1 LOCATION helped me find my dream property in New Cairo within days. Their market knowledge is unmatched, and the team went above and beyond at every step. I felt valued and supported throughout the entire process. Highly recommend!",
    commentAr: "تجربة وساطة عقارية استثنائية! 1 LOCATION ساعدوني ألاقي عقار أحلامي في القاهرة الجديدة خلال أيام. معرفتهم بالسوق لا مثيل لها، والفريق تجاوز كل التوقعات. حسيت إني مُقدّر ومدعوم طوال العملية. أنصح بشدة!",
    verified: true,
    developerReply: {
      author: "1 LOCATION Team",
      authorAr: "فريق 1 LOCATION",
      date: "2024-02-11",
  ...
  },
  {
    ...
    date: "2024-02-15",
    project: "1 LOCATION Brokerage",
    comment: "I've worked with many brokerages in Egypt, and 1 LOCATION is by far the best. Their professionalism, transparency, and genuine care for clients set them apart. They negotiated an incredible deal for me and handled everything seamlessly. A truly five-star experience!",
    commentAr: "اتعاملت مع شركات وساطة كتير في مصر، و1 LOCATION أحسنهم بفارق كبير. احترافيتهم وشفافيتهم واهتمامهم الحقيقي بالعملاء بيميزهم. فاوضوا على صفقة مذهلة ليا وأداروا كل حاجة بسلاسة. تجربة خمس نجوم فعلاً!",
    verified: true,
    developerReply: {
      author: "1 LOCATION Team",
      authorAr: "فريق 1 LOCATION",
      date: "2024-02-16",
      comment: "We truly appreciate your kind words, Mariam! Your trust means the world to us. Welcome to the 1 LOCATION family!",
      commentAr: "نقدر كلامك الجميل يا مريم! ثقتك فينا تعني لنا الكتير. أهلاً بيكي في عيلة 1 LOCATION!",
    },
  },
  {
    id: "18",
    ...
    date: "2024-02-20",
    project: "1 LOCATION Brokerage",
    comment: "From the first consultation to closing the deal, 1 LOCATION exceeded all expectations. Their advisors are incredibly knowledgeable and patient. They found me the perfect investment property with amazing ROI potential. Exceptional service — I'm a client for life!",
    commentAr: "من أول استشارة لحد إتمام الصفقة، 1 LOCATION فاقوا كل التوقعات. مستشاريهم عندهم معرفة مذهلة وصبر كبير. لقولي عقار الاستثمار المثالي بعائد ممتاز. خدمة استثنائية — أنا عميل مدى الحياة!",
    verified: true,
  },
  {
    id: "19",
    ...
    date: "2024-02-25",
    project: "1 LOCATION Brokerage",
    comment: "What an incredible team! 1 LOCATION made the entire property buying process feel effortless and enjoyable. Their attention to detail, honest advice, and warm hospitality are truly remarkable. I couldn't be happier with my new home. Thank you for making my dream come true!",
    commentAr: "فريق مذهل! 1 LOCATION خلّوا عملية شراء العقار سهلة وممتعة. اهتمامهم بالتفاصيل ونصائحهم الصادقة وحسن ضيافتهم حاجة ملفتة فعلاً. مش ممكن أكون أسعد من كده ببيتي الجديد. شكراً إنكم حققتوا حلمي!",
    verified: true,
    developerReply: {
      author: "1 LOCATION Team",
      authorAr: "فريق 1 LOCATION",
